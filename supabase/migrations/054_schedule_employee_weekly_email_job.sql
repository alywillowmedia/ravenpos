-- Schedule weekly employee schedule emails on Saturdays (for next Monday-Sunday).
-- Requires pg_cron + pg_net extensions and these DB settings:
--   app.settings.supabase_url
--   app.settings.employee_schedule_cron_secret
